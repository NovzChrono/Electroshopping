                ...
                <div class="row">
                    <div class="col-md-3 mb-2 d-none d-sm-block ">
                        <div class="card border-0">
                            <div class="card-body">
                                <h5 class="border-bottom pb-2" style="color:rgb(136, 133, 133)"><i>Recherche par</i></h5>
                                <h5 class=" text-uppercase mb-3 mt-3">catégorie</h5>
                                <div class="row">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-10">
                                        @foreach ($categories as $item)
                                            <h6 class="mb-3">
                                                <a class="text-dark" href="{{ url('/categories/'. $item-> libelleCatMat .'/'. $search) }}">
                                                    {{ $item-> libelleCatMat }}
                                                </a>
                                            </h6>
                                        @endforeach
                                ...
                                <h5 class="mt-2 text-uppercase mb-3">Marque</h5>
                                <div class="row">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-10 text-dark">
                                        @foreach ($marques as $item)
                                            <div class="mb-3">
                                                <a href="{{ url('/marques/'. $item-> nom .'/'. $search) }}" class="text-capitalize text-dark">
                                        ...
                                        @foreach ($materiels as $item)
                                            <div class="col-md-3 mb-3 hover_mat rounded">
                                                <a class="text-decoration-none text-black" href="{{url('/categorie/'.$item->categorie_materiel->libelleCatMat .'/'.$item->id)}}">
                                                    <div class="card border-0">
                                                        <center><img class="card-img-top img-materiel" style="" src="{{asset('assets/uploads/materiel/'. $item->image_mat)}}" alt="img produit"></center>
                                                        <div class="card-body">
