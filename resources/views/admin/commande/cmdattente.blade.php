        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-secondary text-white">
                    <div class="row">
                        <div class="col-md-10">
                            <h4 class="pt-3">Suivie de la commande </h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 fs-6 mt-4">
                            ...
                            @if ($cmd-> statut == 0)
                                <form action="{{url('commande/attente/update/'. $cmd ->id)}}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                            <label class="me-5 fs-4" for="st">Statut de la commande</label>
                                        </div>
                                        <div class="col-md-5">
                                            <select name="cmd_statut" id="st" class="form-select" aria-label="Default select">
