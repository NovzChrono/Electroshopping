            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9"><h3 class="pt-2">Commandes en cours</h3></div>
                            <div class="col-md-2"><a href="{{url('/commandes/complete')}}" class="btn btn-primary">Historique commandes</a></div>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table">
